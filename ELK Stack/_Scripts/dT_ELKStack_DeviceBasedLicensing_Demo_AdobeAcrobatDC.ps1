...
"@
    ...
    Invoke-WebRequest -Uri "http://dtldlt02.demo.devicetrust.local:9200/dt_devicebasedlicensing_adobe_acrobat_dc/_update/$Device" -Method "POST" -ContentType "application/json" -Body $json | Out-Null
