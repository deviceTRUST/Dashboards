...
"@
   ...
   #Write-Host "$Application, $Date, $LicensedStatus, $Device, $DEVICE_HARDWARE_BIOS_SERIAL, $DEVICE_OS_ID, $ApplicationUserState, $Domain, $User"
    ...
    Invoke-WebRequest -Uri "http://dtldlt02.demo.devicetrust.local:9200/dt_devicebasedlicensing_microsoft_visio/_update/$Device" -Method "POST" -ContentType "application/json" -Body $json | Out-Null
